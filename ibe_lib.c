/* 
 * NTRG IBE WINCE -- ibe_lib.c
 * Patroklos Argyroudis <argp at domain cs.tcd.ie>
 *
 * Modified version of ibe_lib.c for compilation of the Stanford IBE
 * library on WinCE.
 *
 * $Id: ibe_lib.c,v 1.3 2006/02/13 21:56:37 argp Exp $
 */

/* IBE library routines, see ibe_lib.h for usage
 * Ben Lynn
 */
...
//t of them are required to generate a key
{
    ...
    //whose constant term = master
				...
				poly = (mpz_t *)malloc((sizeof(mpz_t) * t));
				y = (mpz_t *)malloc((sizeof(mpz_t) * n));
