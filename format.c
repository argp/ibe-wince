/* 
 * NTRG IBE WINCE -- format.c
 * Patroklos Argyroudis <argp at domain cs.tcd.ie>
 *
 * Modified version of format.c for compilation of the Stanford IBE
 * library on WinCE.
 *
 * $Id: format.c,v 1.2 2006/02/13 21:56:37 argp Exp $
 */
...
int FMT_split_master(char **fname, byte_string_t master, int t, int n, params_t params)
{
    ...
    /* byte_string_t mshare[n]; */
				byte_string_t *mshare;
    int result = 1;

				mshare = (byte_string_t *)malloc((sizeof(byte_string_t) * n));
	...
	char **fname, int t, params_t params)
{
    ...
    /* byte_string_t mshare[t]; */
				...
				mshare = (byte_string_t *)malloc((sizeof(byte_string_t) * t));
